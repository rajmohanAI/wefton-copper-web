...
const BANNER_SLIDES: BannerSlide[] = [
  {
    id: 'slide-1',
    headline: 'Redefining Essential Wear',
    subheading: 'Premium Micro-French Terry — crafted from the thread up',
    ctaText: 'Shop Men',
    ctaHref: '/men',
  ...
  {
    id: 'slide-2',
    headline: 'The Copper Standard',
    subheading: 'Copper-stitched seams. Architectural collars. Unmatched quality.',
    ctaText: 'Shop Women',
    ctaHref: '/women',
